  ...
  <div class="row">
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/10+ real brides who picked Marwar Couture for their wedding day!.jpeg" class="card-img-top" alt="Lehenga 1">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/B1.jpeg" class="card-img-top" alt="Lehenga 2">
          <div class="card-body text-center">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/Bridal dress fashion.jpeg" class="card-img-top" alt="Lehenga 3">
          <div class="card-body text-center">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/bridal lehenga 💞.jpeg" class="card-img-top" alt="Lehenga 4">
          <div class="card-body text-center">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/b5.jpg" class="card-img-top" alt="Lehenga 3">
          <div class="card-body text-center">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/b8.jpg" class="card-img-top" alt="Lehenga 3">
          <div class="card-body text-center">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/Brocade Kali Lehenga With Sequin Embroidery Dupatta - Etsy.jpeg" class="card-img-top" alt="Lehenga 3">
          <div class="card-body text-center">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/download (7).jpeg" class="card-img-top" alt="Lehenga 3">
          <div class="card-body text-center">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/download (8).jpeg" class="card-img-top" alt="Lehenga 3">
          <div class="card-body text-center">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/Gold dahlia lehenga set.jpeg" class="card-img-top" alt="Lehenga 3">
          <div class="card-body text-center">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/Purple Wedding Lehenga Choli - Indian Bridal Wear _ BAnu.jpeg" class="card-img-top" alt="Lehenga 3">
          <div class="card-body text-center">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/Sabyasachi Inspired Dark Burgundy Wedding Lehenga.jpeg" class="card-img-top" alt="Lehenga 3">
          <div class="card-body text-center">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/Top 50+ Bridal Lehenga Designs - Trending Bridal Lehenga.jpeg" class="card-img-top" alt="Lehenga 3">
          <div class="card-body text-center">
    ...
    <div class="col-lg-3">
      <form action="manage_cart.php" method="POST">
        <div class="card">
          <img src="/bpic/Intimate Farmhouse Wedding In Ahmedabad With A Minimal, Beautiful Bride.jpeg" class="card-img-top" alt="Lehenga 3">
          <div class="card-body text-center">
